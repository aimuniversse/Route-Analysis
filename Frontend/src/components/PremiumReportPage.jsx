      ...
      <div className="report-content-wrapper">
        ...
        <section className="analysis-section-box section-spacing suggested-routes-container">
          <div className="section-main-header">
            <div className="title-area">
              <div className="header-icon-box">
                <MapPin className="header-icon" fill="#ffcc00" size={24} />
              </div>
              <div className="header-text">
                <h2>Suggested Routes</h2>
                <p>Optimized routes for efficient and reliable industrial connectivity</p>
              </div>
            </div>
          </div>

          <div className="suggested-routes-content">
            <div className="routes-list-column">
              {suggestedRoutes.map((route) => (
                <div key={route.id} className="route-card-analysis" style={{ '--accent-color': route.color }}>
                  <div className="card-top-tag">
                    <span className="tag-badge">
                      <Sparkles size={12} /> {route.type}
                    </span>
                  </div>
                  
                  <div className="card-main-body">
                    <div className="route-icon-side">
                      <div className="icon-circle" style={{ backgroundColor: route.color }}>
                        {route.icon}
                      </div>
                    </div>
                    
                    <div className="route-info-side">
                      <h3>{route.name}</h3>
                      <div className="route-stats-row">
                        <div className="stat-pill"><Clock size={14} /> {route.time}</div>
                        <div className="stat-pill"><Navigation size={14} /> {route.distance}</div>
                      </div>
                    ...
                    <div className="efficiency-box">
                      <div className="eff-header">
                        {route.id === 1 ? <ShieldCheck size={18} /> : route.id === 2 ? <Leaf size={18} /> : <Activity size={18} />}
                        <span>{route.efficiency}</span>
                      </div>
                      <p>{route.efficiencyDesc}</p>
                    </div>
                  </div>
            ...
            <div className="map-view-column">
              <div className="map-card-wrapper">
                <div className="map-legend">
                  <div className="legend-item"><span className="line primary"></span> Primary Route</div>
                  <div className="legend-item"><span className="line alt"></span> Alternative Route</div>
                  <div className="legend-item"><span className="line bypass"></span> Southern Bypass</div>
                </div>
                
                <div className="map-placeholder-image">
                  <img src="/map_bg.png" alt="Map Background" className="map-geo-bg" />
                  
                  <svg className="map-routes-svg" viewBox="0 0 100 100" preserveAspectRatio="none">
                    {/* Primary Route */}
                    <path 
                      d="M 22,65 Q 28,60 35,55 T 53,42 T 72,22" 
                      className="route-path-svg primary" 
                      fill="none" 
                    />
                    {/* Alternative Route */}
                    <path 
                      d="M 35,55 Q 40,50 42,45 T 42,30 T 72,22" 
                      className="route-path-svg alt" 
                      fill="none" 
                    />
                    {/* Southern Bypass */}
                    <path 
                      d="M 32,85 Q 40,80 45,75 T 62,65 T 80,55" 
                      className="route-path-svg bypass" 
                      fill="none" 
                    />
                  </svg>

                  <div className="map-city-pin vellore" style={{ top: '22%', left: '72%' }}><span>Vellore</span></div>
                  <div className="map-city-pin krishnagiri" style={{ top: '30%', left: '42%' }}><span>Krishnagiri</span></div>
                  <div className="map-city-pin dharmapuri" style={{ top: '45%', left: '42%' }}><span>Dharmapuri</span></div>
                  <div className="map-city-pin salem" style={{ top: '42%', left: '53%' }}><span>Salem</span></div>
                  <div className="map-city-pin erode" style={{ top: '55%', left: '35%' }}><span>Erode</span></div>
                  <div className="map-city-pin tirupur" style={{ top: '65%', left: '22%' }}><span>Tirupur</span></div>
                  <div className="map-city-pin villupuram" style={{ top: '55%', left: '80%' }}><span>Villupuram</span></div>
                  <div className="map-city-pin trichy" style={{ top: '65%', left: '62%' }}><span>Trichy</span></div>
                  <div className="map-city-pin dindigul" style={{ top: '75%', left: '45%' }}><span>Dindigul</span></div>
                  <div className="map-city-pin pollachi" style={{ top: '85%', left: '32%' }}><span>Pollachi</span></div>
                </div>
          ...
          <div className="suggested-routes-footer">
            <div className="footer-widget">
              <div className="widget-icon"><ShieldCheck size={20} /></div>
              <div className="widget-text">
                <strong>Trusted & Reliable</strong>
                <p>Routes verified for industrial transport & logistics</p>
              </div>
            </div>
            <div className="footer-widget">
              <div className="widget-icon"><Timer size={20} /></div>
              <div className="widget-text">
                <strong>Time-Saving</strong>
                <p>Optimized paths to reduce travel time & delays</p>
              </div>
            </div>
            <div className="footer-widget">
              <div className="widget-icon"><Fuel size={20} /></div>
              <div className="widget-text">
                <strong>Cost-Effective</strong>
                <p>Efficient routes for better fuel economy</p>
              </div>
            </div>
          </div>
        </section>
